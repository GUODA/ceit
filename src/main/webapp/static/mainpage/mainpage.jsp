    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      ...
      <div class="row placeholders">
        <div class="col-xs-6 col-sm-3 placeholder">
          <img src="../images/1.jpg" class="img-responsive" alt="Generic placeholder thumbnail">
          <div class="labels">
            <h4>权限</h4>
        ...
        <div class="col-xs-6 col-sm-3 placeholder">
          <img src="../images/2.jpg" class="img-responsive" alt="Generic placeholder thumbnail">
          <div class="labels">
            <h4>角色</h4>
            <span class="text-muted">Something else</span>
          </div>
