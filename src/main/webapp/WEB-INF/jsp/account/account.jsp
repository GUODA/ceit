...
<nav role="navigation" class="navbar navbar-default">
  <div class="navbar-header">
    ...
    <a href="addpage" class="navbar-brand"><button type="button" class="btn btn-danger btn-lg">添 加 账 号</button></a>
  </div>
        ...
        <table class="table table-striped">
          ...
          List<Account> accounts=(List<Account>)request.getAttribute("accounts");
            for(Account account: accounts){
              out.print("<tr>"+
                      "<td>"+account.getId()+"</td>"+
                      "<td>"+account.getAccountinfo()+"</td>"+
                      "<td>"+account.getAccount()+"</td>"+
                      "<td>"+account.getAccountPassword()+"</td>"+
                      "<td>"+
                      "<a href=\"edit\" onclick=\"$('#d1').data('dialog').toggle()\"><button type=\"button\" class=\"btn btn-primary\">修 改</button></a>\n" +
