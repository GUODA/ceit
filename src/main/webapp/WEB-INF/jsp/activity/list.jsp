...
<%@ page import="com.app.pojo.Activity" %>
...
<head>
  ...
  <script src="/staticjs/metro.js"></script>
  <script src="/staticjs/docs.js"></script>
  <script src="/staticjs/prettify/run_prettify.js"></script>
  <script src="/staticjs/ga.js"></script>
...
<nav role="navigation" class="navbar navbar-default">
  <div class="navbar-header">
    ...
    <a href="addpage" class="navbar-brand"><button type="button" class="btn btn-danger btn-lg">添 加 活 动</button></a>
  </div>
    ...
    <div class="col-sm-2  col-md-12 main">
      ...
      <div class="table-responsive">
        <table class="table table-striped">
          ...
          <tbody>
          <%
            List<Activity> accounts=(List<Activity>)request.getAttribute("activities");
            for(Activity activity: activities){
              out.print("<tr>"+
                      "<td>"+activity.getId()+"</td>"+
                      "<td>"+activity.getName()+"</td>"+
                      "<td>"+activity.getTime()+"</td>"+
                      "<td>"+activity.getDes()+"</td>"+
                      "<td>"+
                      "<a href=\"edit\" ><button type=\"button\" class=\"btn btn-primary\">修 改</button></a>\n" +
                      "<a href=\"account/delete\"><button type=\"button\" class=\"btn btn-info\">删 除</button></a>"+
                      "</td>"+
                      "</tr>");
            }
          %>
